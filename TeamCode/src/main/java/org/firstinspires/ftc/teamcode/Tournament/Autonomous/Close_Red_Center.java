...
@Autonomous(name = "Close Red Auto Center", group = "Autonomous")
public class Close_Red_Center extends LinearOpMode {

    Zoinkifier robot;
    int strafeDistance = robot.CLOSE_STONE_MIDDLE_SLOT;
